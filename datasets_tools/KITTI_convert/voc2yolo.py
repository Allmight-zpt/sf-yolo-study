...
def changeformat():
    img_path = 'D:\\file\data_object_image_2\\training\image_2\*.png'  # 修改为自己的 KITTI数据集图像位置
    label_path = 'D:\\file\data_object_label_2\\training\label_2\\'  # 修改为自己的 KITTI数据集标签位置
    filename_list = glob.glob(img_path)
    save_path = 'D:\\file\data_object_image_2\\training\labels\\'  # 修改为自己的 标签另存的位置
