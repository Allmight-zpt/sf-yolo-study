...
def voc2yolo(path):
    ...
    output_folder = path.replace('Annotations', 'labels')
    ...
    for file in os.listdir(path):
        ...
        out_file = open(output_folder + file.replace('xml', 'txt'), 'w')
        # print(label_file)
...
if __name__ == '__main__':
	# 这里要改成自己数据集路径的格式
    path = './foggy_cityscapes_beta_0.01_voc_format/VOC2007/Annotations/'
    voc2yolo(path)
